...
class GF_Checkout_Com_License_Updates {

	const SECRET_KEY = '5b2e2491cc5129.56732842';
	const SERVER_URL = 'https://wpgateways.com';
	const LONG_NAME = 'Gravity Forms Checkout.com Gateway';
	const SHORT_NAME = 'Gravity Forms Checkout.com';
	const VAR_IDS = '35955,35956,35957,35958,35959,35960,35961,35962';
	const PLUGIN_SLUG = 'gravityforms-checkout-com-gateway';
	...
	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new GF_Checkout_Com_License_Updates();
		}
...
GF_Checkout_Com_License_Updates::get_instance();