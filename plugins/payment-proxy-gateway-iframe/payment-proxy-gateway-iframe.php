...
define('PAYMENT_PROXY_GATEWAY_IFRAME_VERSION', '2.1.0.2');
			...
			<form id="payment-form" method="POST">
				...
				<div class="gform_footer top_label iframe-payment-form-footer">
					<div class="information-text">
						<p>By authorizing the payment, I acknowledge that I am purchasing a third-party service not affiliated with any government agency, and I have reviewed and angree to the <a href="https://mypassportcenter.com/terms-and-conditions/">term and conditions</a> and <a href="https://mypassportcenter.com/privacy-policy">privacy policy</a></p>
					</div>
